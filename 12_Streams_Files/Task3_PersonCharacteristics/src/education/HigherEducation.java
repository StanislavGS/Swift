...
public class HigherEducation extends GradedEducation {
    ...
    public HigherEducation(String institutionName,LocalDate enrollmentDate, LocalDate graduationDate,float finalGrade,EducationDegree degree){
        super(institutionName, enrollmentDate, graduationDate, finalGrade,degree);
        this.degree=degree;
    }
